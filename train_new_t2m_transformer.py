...
from models.mask_transformer.new_transformer import MaskTransformer
from models.mask_transformer.new_transformer_trainer import MaskTransformerTrainer
...
if __name__ == '__main__':
    ...
    trainer = MaskTransformerTrainer(opt, t2m_transformer, vq_model, cond_mode='text')
