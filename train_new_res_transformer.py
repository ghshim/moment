...
from models.mask_transformer.new_transformer import ResidualTransformer
from models.mask_transformer.new_transformer_trainer import ResidualTransformerTrainer
...
if __name__ == '__main__':
    ...
    trainer = ResidualTransformerTrainer(opt, res_transformer, vq_model, cond_mode='text')
